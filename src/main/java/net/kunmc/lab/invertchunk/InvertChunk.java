...
public final class InvertChunk extends JavaPlugin implements Listener {
    private final String metadataKey = "enablePhysics";
    public static TaskScheduler taskScheduler;
    public static InvertChunk instance;
    ...
    public void onEnable() {
        ...
        getServer().getPluginCommand("invertchunk").setExecutor(new CommandHandler());
    }
